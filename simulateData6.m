...
%}
iX1 = randomDiscrete(pInf*ones(1,nFirms));
iX2 = randomDiscrete(pInf*ones(1,nFirms));
%{
...
choicestype1  = deltaUtype1(iX1,1)' > deltaEpsilon;
choicestype2  = deltaUtype2(iX2,1)' > deltaEpsilon;
%{
...
%}
for t = 2:nPeriods
	iX1 = [iX1;randomDiscrete(capPi(iX1(end,:),:)')];
	deltaEpsilon  = random('ev',zeros(1,nFirms),ones(1,nFirms))-random('ev',zeros(1,nFirms),ones(1,nFirms));
	choicestype1 = [choicestype1;(deltaUtype1(iX1(end,:)+nSuppX*choicestype1(end,:)) > deltaEpsilon)];
end
